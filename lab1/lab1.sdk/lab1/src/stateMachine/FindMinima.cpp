...
void FindMinima::ReturnResult(Context*){
	std::cout << "merp" << std::endl;
}

void FindMinima::ChangeState(Context* c, State* s){
	c->change_state(s);
}
