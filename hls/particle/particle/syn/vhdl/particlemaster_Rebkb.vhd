...
entity particlemaster_Rebkb_rom is 
    generic(
             dwidth     : integer := 6; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of particlemaster_Rebkb_rom is 
...
entity particlemaster_Rebkb is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of particlemaster_Rebkb is
    component particlemaster_Rebkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    particlemaster_Rebkb_rom_U :  component particlemaster_Rebkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
