...
entity particlemaster_RedEe_rom is 
    generic(
             dwidth     : integer := 105; 
             awidth     : integer := 4; 
             mem_size    : integer := 16
...
architecture rtl of particlemaster_RedEe_rom is 
...
entity particlemaster_RedEe is
    generic (
...
architecture arch of particlemaster_RedEe is
    component particlemaster_RedEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    particlemaster_RedEe_rom_U :  component particlemaster_RedEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
