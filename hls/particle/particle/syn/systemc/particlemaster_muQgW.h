...
#ifndef __particlemaster_muQgW__HH__
#define __particlemaster_muQgW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muQgW) {
    ...
    SC_CTOR(particlemaster_muQgW):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
