...
#ifndef __particlemaster_muzec__HH__
#define __particlemaster_muzec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muzec) {
    ...
    SC_CTOR(particlemaster_muzec):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
