...
#ifndef __particlemaster_muRg6__HH__
#define __particlemaster_muRg6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muRg6) {
    ...
    SC_CTOR(particlemaster_muRg6):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
