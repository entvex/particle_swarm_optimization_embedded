...
#ifndef __particlemaster_muPgM__HH__
#define __particlemaster_muPgM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muPgM) {
    ...
    SC_CTOR(particlemaster_muPgM):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
