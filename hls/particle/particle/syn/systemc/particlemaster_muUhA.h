...
#ifndef __particlemaster_muUhA__HH__
#define __particlemaster_muUhA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muUhA) {
    ...
    SC_CTOR(particlemaster_muUhA):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
