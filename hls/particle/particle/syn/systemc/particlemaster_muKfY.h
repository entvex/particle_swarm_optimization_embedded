...
#ifndef __particlemaster_muKfY__HH__
#define __particlemaster_muKfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muKfY) {
    ...
    SC_CTOR(particlemaster_muKfY):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
