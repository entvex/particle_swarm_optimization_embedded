...
#ifndef __particlemaster_muxdS__HH__
#define __particlemaster_muxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muxdS) {
    ...
    SC_CTOR(particlemaster_muxdS):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
