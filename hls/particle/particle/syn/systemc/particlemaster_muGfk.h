...
#ifndef __particlemaster_muGfk__HH__
#define __particlemaster_muGfk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muGfk) {
    ...
    SC_CTOR(particlemaster_muGfk):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
