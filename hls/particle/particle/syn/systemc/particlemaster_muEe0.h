...
#ifndef __particlemaster_muEe0__HH__
#define __particlemaster_muEe0__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muEe0) {
    ...
    SC_CTOR(particlemaster_muEe0):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
