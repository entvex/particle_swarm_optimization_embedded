...
#ifndef __particlemaster_muyd2__HH__
#define __particlemaster_muyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muyd2) {
    ...
    SC_CTOR(particlemaster_muyd2):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
