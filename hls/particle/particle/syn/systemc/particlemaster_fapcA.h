...
#ifndef __particlemaster_fapcA__HH__
#define __particlemaster_fapcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_fapcA) {
    ...
    SC_CTOR(particlemaster_fapcA):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
