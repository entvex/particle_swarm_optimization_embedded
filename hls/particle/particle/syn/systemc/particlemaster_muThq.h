...
#ifndef __particlemaster_muThq__HH__
#define __particlemaster_muThq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muThq) {
    ...
    SC_CTOR(particlemaster_muThq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
