...
#ifndef __particlemaster_muNgs__HH__
#define __particlemaster_muNgs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muNgs) {
    ...
    SC_CTOR(particlemaster_muNgs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
