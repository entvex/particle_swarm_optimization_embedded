...
#ifndef __particlemaster_muMgi__HH__
#define __particlemaster_muMgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muMgi) {
    ...
    SC_CTOR(particlemaster_muMgi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
