...
#ifndef __particlemaster_muBew__HH__
#define __particlemaster_muBew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muBew) {
    ...
    SC_CTOR(particlemaster_muBew):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
