...
#ifndef __particlemaster_muLf8__HH__
#define __particlemaster_muLf8__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muLf8) {
    ...
    SC_CTOR(particlemaster_muLf8):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
