...
#ifndef __particlemaster_muAem__HH__
#define __particlemaster_muAem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muAem) {
    ...
    SC_CTOR(particlemaster_muAem):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
