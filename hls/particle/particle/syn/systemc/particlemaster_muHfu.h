...
#ifndef __particlemaster_muHfu__HH__
#define __particlemaster_muHfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muHfu) {
    ...
    SC_CTOR(particlemaster_muHfu):  ACMP_mul_us_U ("ACMP_mul_us_U") {
