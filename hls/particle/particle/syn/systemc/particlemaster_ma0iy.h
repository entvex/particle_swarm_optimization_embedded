...
#ifndef __particlemaster_ma0iy__HH__
#define __particlemaster_ma0iy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_ma0iy) {
    ...
    SC_CTOR(particlemaster_ma0iy):  simcore_mac_0_U ("simcore_mac_0_U") {
