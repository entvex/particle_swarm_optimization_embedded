...
#ifndef __particlemaster_muXh4__HH__
#define __particlemaster_muXh4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muXh4) {
    ...
    SC_CTOR(particlemaster_muXh4):  ACMP_mul_us_U ("ACMP_mul_us_U") {
