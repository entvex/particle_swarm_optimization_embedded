...
#ifndef __particlemaster_muJfO__HH__
#define __particlemaster_muJfO__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muJfO) {
    ...
    SC_CTOR(particlemaster_muJfO):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
