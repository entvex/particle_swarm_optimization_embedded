...
#ifndef __particlemaster_muWhU__HH__
#define __particlemaster_muWhU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muWhU) {
    ...
    SC_CTOR(particlemaster_muWhU):  ACMP_mul_us_U ("ACMP_mul_us_U") {
