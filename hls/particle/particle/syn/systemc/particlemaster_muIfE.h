...
#ifndef __particlemaster_muIfE__HH__
#define __particlemaster_muIfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muIfE) {
    ...
    SC_CTOR(particlemaster_muIfE):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
