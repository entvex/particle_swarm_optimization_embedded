...
#ifndef __particlemaster_muYie__HH__
#define __particlemaster_muYie__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muYie) {
    ...
    SC_CTOR(particlemaster_muYie):  ACMP_mul_us_U ("ACMP_mul_us_U") {
