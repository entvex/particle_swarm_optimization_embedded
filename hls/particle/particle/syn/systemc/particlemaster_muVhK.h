...
#ifndef __particlemaster_muVhK__HH__
#define __particlemaster_muVhK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muVhK) {
    ...
    SC_CTOR(particlemaster_muVhK):  ACMP_mul_us_U ("ACMP_mul_us_U") {
