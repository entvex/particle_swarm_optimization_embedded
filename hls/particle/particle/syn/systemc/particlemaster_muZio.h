...
#ifndef __particlemaster_muZio__HH__
#define __particlemaster_muZio__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muZio) {
    ...
    SC_CTOR(particlemaster_muZio):  ACMP_mul_us_U ("ACMP_mul_us_U") {
