...
#ifndef __particlemaster_muOgC__HH__
#define __particlemaster_muOgC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muOgC) {
    ...
    SC_CTOR(particlemaster_muOgC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
