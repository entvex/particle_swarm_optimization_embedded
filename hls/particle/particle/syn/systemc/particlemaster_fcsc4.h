...
#ifndef __particlemaster_fcsc4__HH__
#define __particlemaster_fcsc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_fcsc4) {
    ...
    SC_CTOR(particlemaster_fcsc4):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
