...
#ifndef __particlemaster_muFfa__HH__
#define __particlemaster_muFfa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muFfa) {
    ...
    SC_CTOR(particlemaster_muFfa):  ACMP_mul_us_U ("ACMP_mul_us_U") {
