...
#ifndef __particlemaster_muShg__HH__
#define __particlemaster_muShg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muShg) {
    ...
    SC_CTOR(particlemaster_muShg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
