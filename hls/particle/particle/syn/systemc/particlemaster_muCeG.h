...
#ifndef __particlemaster_muCeG__HH__
#define __particlemaster_muCeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muCeG) {
    ...
    SC_CTOR(particlemaster_muCeG):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
