...
#ifndef __particlemaster_RedEe_H__
#define __particlemaster_RedEe_H__
...
struct particlemaster_RedEe_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(particlemaster_RedEe_ram) {
...
SC_MODULE(particlemaster_RedEe) {
...
particlemaster_RedEe_ram* meminst;


SC_CTOR(particlemaster_RedEe) {
meminst = new particlemaster_RedEe_ram("particlemaster_RedEe_ram");
