...
#ifndef __particlemaster_muDeQ__HH__
#define __particlemaster_muDeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(particlemaster_muDeQ) {
    ...
    SC_CTOR(particlemaster_muDeQ):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
