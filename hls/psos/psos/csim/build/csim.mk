...
HLS_SOURCES = ../../../main.cpp ../../../psosDriver.cpp ../../../psos.cpp
...
$(ObjDir)/psos.o: ../../../psos.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../psos.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/psos.d
