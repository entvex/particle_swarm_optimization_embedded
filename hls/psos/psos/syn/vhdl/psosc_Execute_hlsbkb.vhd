...
entity psosc_Execute_hlsbkb_rom is 
    generic(
             dwidth     : integer := 6; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of psosc_Execute_hlsbkb_rom is 
...
entity psosc_Execute_hlsbkb is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of psosc_Execute_hlsbkb is
    component psosc_Execute_hlsbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    psosc_Execute_hlsbkb_rom_U :  component psosc_Execute_hlsbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
