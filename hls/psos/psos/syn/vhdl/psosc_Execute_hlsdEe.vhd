...
entity psosc_Execute_hlsdEe_rom is 
    generic(
             dwidth     : integer := 105; 
             awidth     : integer := 4; 
             mem_size    : integer := 16
...
architecture rtl of psosc_Execute_hlsdEe_rom is 
...
entity psosc_Execute_hlsdEe is
    generic (
...
architecture arch of psosc_Execute_hlsdEe is
    component psosc_Execute_hlsdEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    psosc_Execute_hlsdEe_rom_U :  component psosc_Execute_hlsdEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
