...
#ifndef __psosc_mul_92ns_6nPgM__HH__
#define __psosc_mul_92ns_6nPgM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_92ns_6nPgM) {
    ...
    SC_CTOR(psosc_mul_92ns_6nPgM):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
