...
#ifndef __psosc_mul_72ns_13Hfu__HH__
#define __psosc_mul_72ns_13Hfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_72ns_13Hfu) {
    ...
    SC_CTOR(psosc_mul_72ns_13Hfu):  ACMP_mul_us_U ("ACMP_mul_us_U") {
