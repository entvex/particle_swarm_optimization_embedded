...
#ifndef __psosc_mul_54ns_6nLf8__HH__
#define __psosc_mul_54ns_6nLf8__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_54ns_6nLf8) {
    ...
    SC_CTOR(psosc_mul_54ns_6nLf8):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
