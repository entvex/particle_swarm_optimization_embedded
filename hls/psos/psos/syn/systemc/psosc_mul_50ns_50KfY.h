...
#ifndef __psosc_mul_50ns_50KfY__HH__
#define __psosc_mul_50ns_50KfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_50ns_50KfY) {
    ...
    SC_CTOR(psosc_mul_50ns_50KfY):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
