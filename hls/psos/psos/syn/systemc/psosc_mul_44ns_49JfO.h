...
#ifndef __psosc_mul_44ns_49JfO__HH__
#define __psosc_mul_44ns_49JfO__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_44ns_49JfO) {
    ...
    SC_CTOR(psosc_mul_44ns_49JfO):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
