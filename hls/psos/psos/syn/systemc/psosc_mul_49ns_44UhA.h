...
#ifndef __psosc_mul_49ns_44UhA__HH__
#define __psosc_mul_49ns_44UhA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_49ns_44UhA) {
    ...
    SC_CTOR(psosc_mul_49ns_44UhA):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
