...
#ifndef __psosc_mul_43ns_36Thq__HH__
#define __psosc_mul_43ns_36Thq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_43ns_36Thq) {
    ...
    SC_CTOR(psosc_mul_43ns_36Thq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
