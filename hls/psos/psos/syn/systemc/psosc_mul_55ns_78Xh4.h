...
#ifndef __psosc_mul_55ns_78Xh4__HH__
#define __psosc_mul_55ns_78Xh4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_55ns_78Xh4) {
    ...
    SC_CTOR(psosc_mul_55ns_78Xh4):  ACMP_mul_us_U ("ACMP_mul_us_U") {
