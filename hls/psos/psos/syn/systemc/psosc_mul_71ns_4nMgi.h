...
#ifndef __psosc_mul_71ns_4nMgi__HH__
#define __psosc_mul_71ns_4nMgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_71ns_4nMgi) {
    ...
    SC_CTOR(psosc_mul_71ns_4nMgi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
