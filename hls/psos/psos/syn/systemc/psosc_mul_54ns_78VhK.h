...
#ifndef __psosc_mul_54ns_78VhK__HH__
#define __psosc_mul_54ns_78VhK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_54ns_78VhK) {
    ...
    SC_CTOR(psosc_mul_54ns_78VhK):  ACMP_mul_us_U ("ACMP_mul_us_U") {
