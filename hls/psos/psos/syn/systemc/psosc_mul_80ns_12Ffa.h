...
#ifndef __psosc_mul_80ns_12Ffa__HH__
#define __psosc_mul_80ns_12Ffa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_80ns_12Ffa) {
    ...
    SC_CTOR(psosc_mul_80ns_12Ffa):  ACMP_mul_us_U ("ACMP_mul_us_U") {
