...
#ifndef __psosc_mul_73ns_6nNgs__HH__
#define __psosc_mul_73ns_6nNgs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_73ns_6nNgs) {
    ...
    SC_CTOR(psosc_mul_73ns_6nNgs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
