...
#ifndef __psosc_mul_82ns_6nRg6__HH__
#define __psosc_mul_82ns_6nRg6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_82ns_6nRg6) {
    ...
    SC_CTOR(psosc_mul_82ns_6nRg6):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
