...
#ifndef __psosc_mul_77ns_6nShg__HH__
#define __psosc_mul_77ns_6nShg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_77ns_6nShg) {
    ...
    SC_CTOR(psosc_mul_77ns_6nShg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
