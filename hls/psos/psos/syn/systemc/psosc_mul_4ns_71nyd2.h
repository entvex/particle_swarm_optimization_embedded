...
#ifndef __psosc_mul_4ns_71nyd2__HH__
#define __psosc_mul_4ns_71nyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_4ns_71nyd2) {
    ...
    SC_CTOR(psosc_mul_4ns_71nyd2):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
