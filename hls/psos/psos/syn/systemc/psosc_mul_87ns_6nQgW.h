...
#ifndef __psosc_mul_87ns_6nQgW__HH__
#define __psosc_mul_87ns_6nQgW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_87ns_6nQgW) {
    ...
    SC_CTOR(psosc_mul_87ns_6nQgW):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
