...
#ifndef __psosc_mul_36ns_43IfE__HH__
#define __psosc_mul_36ns_43IfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_36ns_43IfE) {
    ...
    SC_CTOR(psosc_mul_36ns_43IfE):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
