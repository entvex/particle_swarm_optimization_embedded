...
#ifndef __psosc_mac_muladd_0iy__HH__
#define __psosc_mac_muladd_0iy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mac_muladd_0iy) {
    ...
    SC_CTOR(psosc_mac_muladd_0iy):  simcore_mac_0_U ("simcore_mac_0_U") {
