...
#ifndef __psosc_faddfsub_32ncg__HH__
#define __psosc_faddfsub_32ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_faddfsub_32ncg) {
    ...
    SC_CTOR(psosc_faddfsub_32ncg):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
