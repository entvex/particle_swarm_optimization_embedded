...
#ifndef __psosc_mul_6ns_92nBew__HH__
#define __psosc_mul_6ns_92nBew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_6ns_92nBew) {
    ...
    SC_CTOR(psosc_mul_6ns_92nBew):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
