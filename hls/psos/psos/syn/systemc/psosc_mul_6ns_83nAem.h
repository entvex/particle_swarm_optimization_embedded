...
#ifndef __psosc_mul_6ns_83nAem__HH__
#define __psosc_mul_6ns_83nAem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_6ns_83nAem) {
    ...
    SC_CTOR(psosc_mul_6ns_83nAem):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
