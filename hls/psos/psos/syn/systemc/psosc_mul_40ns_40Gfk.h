...
#ifndef __psosc_mul_40ns_40Gfk__HH__
#define __psosc_mul_40ns_40Gfk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_40ns_40Gfk) {
    ...
    SC_CTOR(psosc_mul_40ns_40Gfk):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
