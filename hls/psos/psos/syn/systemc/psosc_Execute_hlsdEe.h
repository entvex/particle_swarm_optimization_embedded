...
#ifndef __psosc_Execute_hlsdEe_H__
#define __psosc_Execute_hlsdEe_H__
...
struct psosc_Execute_hlsdEe_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(psosc_Execute_hlsdEe_ram) {
...
SC_MODULE(psosc_Execute_hlsdEe) {
...
psosc_Execute_hlsdEe_ram* meminst;


SC_CTOR(psosc_Execute_hlsdEe) {
meminst = new psosc_Execute_hlsdEe_ram("psosc_Execute_hlsdEe_ram");
