...
#ifndef __psosc_mul_56ns_78Zio__HH__
#define __psosc_mul_56ns_78Zio__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_56ns_78Zio) {
    ...
    SC_CTOR(psosc_mul_56ns_78Zio):  ACMP_mul_us_U ("ACMP_mul_us_U") {
