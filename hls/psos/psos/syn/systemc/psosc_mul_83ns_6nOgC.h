...
#ifndef __psosc_mul_83ns_6nOgC__HH__
#define __psosc_mul_83ns_6nOgC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_83ns_6nOgC) {
    ...
    SC_CTOR(psosc_mul_83ns_6nOgC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
