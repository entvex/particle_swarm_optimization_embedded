...
#ifndef __psosc_mul_6ns_82nDeQ__HH__
#define __psosc_mul_6ns_82nDeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_6ns_82nDeQ) {
    ...
    SC_CTOR(psosc_mul_6ns_82nDeQ):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
