...
#ifndef __psosc_mul_6ns_87nCeG__HH__
#define __psosc_mul_6ns_87nCeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_6ns_87nCeG) {
    ...
    SC_CTOR(psosc_mul_6ns_87nCeG):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
