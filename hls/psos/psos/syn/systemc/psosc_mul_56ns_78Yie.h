...
#ifndef __psosc_mul_56ns_78Yie__HH__
#define __psosc_mul_56ns_78Yie__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(psosc_mul_56ns_78Yie) {
    ...
    SC_CTOR(psosc_mul_56ns_78Yie):  ACMP_mul_us_U ("ACMP_mul_us_U") {
