...
wire [32 - 1:0] sig_floatPrototypec_float1;
wire [32 - 1:0] sig_floatPrototypec_float2;
wire [32 - 1:0] sig_floatPrototypec_float3;

wire sig_floatPrototypec_reset;



floatPrototypec floatPrototypec_U(
    .float1(sig_floatPrototypec_float1),
    .float2(sig_floatPrototypec_float2),
    .float3(sig_floatPrototypec_float3),
    .reset(sig_floatPrototypec_reset),
    .clk(aclk)
);

floatPrototypec_slv0_if #(
    .C_ADDR_WIDTH(C_S_AXI_SLV0_ADDR_WIDTH),
    .C_DATA_WIDTH(C_S_AXI_SLV0_DATA_WIDTH))
floatPrototypec_slv0_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_float1(sig_floatPrototypec_float1),
    .I_float2(sig_floatPrototypec_float2),
    .O_float3(sig_floatPrototypec_float3),
...
floatPrototypec_reset_if #(
    .RESET_ACTIVE_LOW(RESET_ACTIVE_LOW))
reset_if_U(
    .dout(sig_floatPrototypec_reset),
    .din(aresetn));
